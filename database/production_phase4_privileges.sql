...
-- Sensitive tables are server-only. RLS remains enabled, while the trusted
-- Supabase service_role receives the table privileges needed by the API.
...
-- These tables/functions are not intended for browser roles.
