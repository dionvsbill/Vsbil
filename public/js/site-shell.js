(() => {
  ...
  async function routeAuthenticatedAuthPage() {
    ...
    if (user) location.replace(user.status === "active" ? "/dashboard.html" : "/activate.html");
  }
  ...
  function navigation() {
    ...
    const links=[
      ...
      ["▤","Business","/business.html"],["◇","Shop","/business.html#inventory"],["◉","WhatsApp","/whatsapp-bot.html"],
      ["✉","Messages","/messages.html"],["♢","Notifications","/notifications.html"],["▦","Dashboard","/dashboard.html"],["⚙","Settings","/settings.html"]
    ];
    const current=path();
    const active=href=>href==="/"?current==="/":current===href || (href==="/business.html#inventory" && current==="/business.html");
    ...
    top.innerHTML=`<a class="vsbil-mobile-brand" href="/"><img src="${LOGO}" alt="VSBIL"><span>VSBIL</span></a><label class="vsbil-global-search"><span>⌕</span><input type="search" placeholder="Search VSBIL" aria-label="Search VSBIL"></label><div class="vsbil-global-actions"><a href="/notifications.html" aria-label="Notifications">♢</a>${hasSessionToken()?`<a href="/profile.html" class="vsbil-top-avatar" aria-label="Profile">U</a>`:`<a href="/login.html" class="vsbil-signin">Sign in</a>`}</div>`;
    ...
    // Existing page-specific headers/sidebars are content layouts, not a second application shell.
  ...
  function footer() {
    ...
    document.body.insertAdjacentHTML("beforeend",`<footer id="${FOOTER}" class="site-footer vsbil-global-footer"><div class="vsbil-footer-inner"><div class="vsbil-footer-grid"><div class="vsbil-footer-brand"><a class="vsbil-footer-brandmark" href="/"><img src="${LOGO}" alt=""><span>VSBIL</span></a><p>A modern platform for creators, communities, verified commerce and practical business tools.</p><div class="vsbil-footer-status"><span class="vsbil-status-dot"></span>Platform online</div></div><div class="vsbil-footer-col"><h4>Platform</h4><a href="/about.html">About VSBIL</a><a href="/social.html">Community</a><a href="/activities.html">Activities</a><a href="/creator.html">Creator Hub</a><a href="/faq.html">Help Center</a></div><div class="vsbil-footer-col"><h4>Business</h4><a href="/business.html">Business Suite</a><a href="/shop-admin.html">Shop Manager</a><a href="/order-track.html">Order Tracking</a><a href="/whatsapp-bot.html">WhatsApp Automation</a><a href="/advertise.html">Advertising</a></div><div class="vsbil-footer-col"><h4>Account</h4>${accountLinks}</div><div class="vsbil-footer-col"><h4>Trust &amp; Support</h4><a href="/support.html">Support &amp; Reports</a><a href="/contact.html">Contact Us</a><a href="/legal.html">Trust Center</a><a href="/privacy.html">Privacy</a><a href="/terms.html">Terms</a><a href="/security.html">Security</a><a href="/community-guidelines.html">Community Guidelines</a><a href="/acceptable-use.html">Acceptable Use</a></div></div><div class="vsbil-footer-bottom"><span>© ${new Date().getFullYear()} VSBIL. All rights reserved.</span><span class="vsbil-footer-legal"><a href="/privacy.html">Privacy</a><a href="/terms.html">Terms</a><a href="/cookie-policy.html">Cookies</a><a href="/data-rights.html">Data Rights</a></span></div></div></footer>`);
  }

  function boot(){ if(isAuthPage()){ routeAuthenticatedAuthPage(); return; } if(isBusinessPage()) return; loader(); navigation(); footer(); document.documentElement.classList.add("vsbil-shell-ready"); }
